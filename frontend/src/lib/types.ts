// ============================================================
// EdilEngine - TypeScript Types
// Corrispondenti ai Pydantic schemas del backend FastAPI
// ============================================================

// ---- Leggi ----
export interface LeggeBase {
  id?: string;                       // UUID (da aggiornare nel backend schema LeggeBase)
  titolo: string;
  tipo: string | null;
  numero: string | null;
  data_emanazione: string | null;   // date -> ISO string
...
export interface IncentivoBase {
  id?: string;                       // UUID (da aggiornare nel backend schema IncentivoBase)
  titolo: string;
